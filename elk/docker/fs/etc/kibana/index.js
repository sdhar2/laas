...
var dns = require('dns');
var elkIP;
dns.lookup('elk', function callback(err, address, family){
  console.log('Resolved IP address for DNS ELK:', address);
  elkIP = address;
});
    ...
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 88:
        ...
        server.route({
          ...
          method: 'GET',
          handler: function handler(req, reply) {
              return reply.redirect('http:' + elkIP + ':9200/_plugin/kopf');
            }
        });
