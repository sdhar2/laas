...
openssl x509 -inform der -in $cn_value.cer -out server-cert.pem
...
cp server-private-key-nopassphrase.pem ca.pem server-cert.pem /home/docker/cloud-service-scripts/certificates/ELK/keys
